...
function FeatureTwo() {
  return (
    <main className='flex flex-col md:h-[70vh] md:flex-row-reverse md:items-center'>
      {/* Text Holder */}
      <div className='bg-expenses bg-cover md:bg-contain md:bg-center bg-no-repeat h-96 md:h-full w-full md:w-1/2'></div>

      {/* Image Holder */}
      <div className='flex flex-col md:w-1/2'>
        <h1 className="font-nunito font-semi-bold text-3xl text-center">Manage Your Expenses</h1>
